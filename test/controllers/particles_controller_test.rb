...
class ParticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create particle" do
    assert_difference('Particle.count') do
      post particles_url, params: { particle: { description: @particle.description, image_url: @particle.image_url, price: @particle.price, title: @particle.title } }
    end
  ...
  test "should update particle" do
    patch particle_url(@particle), params: { particle: { description: @particle.description, image_url: @particle.image_url, price: @particle.price, title: @particle.title } }
